...
<div aria-live="assertive" class="fixed inset-0 z-30 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start">
    <div class="w-full flex flex-col items-center space-y-4 sm:items-end">
        @if ($message)
            <div x-show="isNotificationShow" x-init="setTimeout(() => isNotificationShow = true, 200);
            setTimeout(() => isNotificationShow = false, 5000)"
                ...
                <div class="p-4">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-shrink-0 flex">
                            <button type="button" x-on:click="isNotificationShow = !isNotificationShow"
